...
class CreateUserMonthlyPaymentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('user_monthly_payments', function (Blueprint $table) {
            $table->id('id');
    ...
    {
        Schema::dropIfExists('user_monthly_payments');
    }
}
